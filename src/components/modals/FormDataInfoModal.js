...
const FormDataInfoModal = (props) => {
  const { formData, bilagItems, sendData } = props;
  ...
  return (
    <div id="modal-expand" className="modal modal-fixed-footer">
      ...
      {sendData ? (
          ...
          <div className="row">
            <div className="col s10">
              <a
                ...
                onClick={sendData}
              >
                Send til behandling <i className="material-icons left">send</i>
              </a>
            </div>
            <div className="col">
              <a
        ...
        <div className="modal-footer">
          <a className="modal-close waves-effect waves-green btn-flat">Luk</a>
        </div>
      )}
    </div>
  );
...
export default FormDataInfoModal;
